            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/members">
                        ...
                        <div class="form-group row">
                            <label for="affiliation" class="col-md-4 col-form-label text-md-right">{{ __('School / Company') }}</label>

                            <div class="col-md-6">
                                <input id="affiliation" type="text" class="form-control @error('affiliation') is-invalid @enderror" name="affiliation" value="{{ old('affiliation') }}" autocomplete="affiliation" autofocus>
